...
| `scripts/fetch_icons_multicloud.sh` | Azure (official pack, pass a newer URL as `$1`), Google Cloud (official set, mirrored) and the data-platform marks. Run it to refresh `examples/icons/{azure,gcp}/` and the root marks. |
